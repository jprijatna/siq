sap.ui.define([
	...
	return Controller.extend("com.deloitte.smartservice.SMARTSERVICE.controller.SmsAnalyticsDetail", {
		...
		onNavBack: function() {
			...
			sap.ui.core.UIComponent.getRouterFor(this).navTo("SmsAnalytics");
		},
		/**
		...
		onPatternMatch: function(oEvent) {
			if (oEvent.getParameter("name") === "SmsAnalyticsDetail") {
				//var today = new Date();
				...
				/*var html1 = new sap.ui.core.HTML({
					content: "<audio controls><source src='http://developer.mozilla.org/@api/deki/files/2926/=AudioTest_(1).ogg'" +
					"type='audio/ogg' >" +
